...
const ECommerce = () => {
    ...
    return (
        <div className="container-web">
            ...
            <h1 className="title">Web E-Commerce</h1>
            <hr className="lineHr"/>
            <p className="desc">Berbelanja berbagai keperluan Baju Muslim</p>
            <img className="fotoUtama" src="/assets/4.png"/>
            <hr className="lineHr-2"/>
            <p className="desc">Membuat tampilan website yang memberikan informasi terkait baju yang brandit 
            </p>
