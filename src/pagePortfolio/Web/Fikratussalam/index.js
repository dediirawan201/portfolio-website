...
const Fikratussalam = () => {
    ...
    return (
        <div className="container-web">
            ...
            <h1 className="title">Web Fikratussalam</h1>
            <hr className="lineHr"/>
            <p className="desc">Mengenal Fikratussalam melalui website</p>
            <img className="fotoUtama" src="/assets/3.png"/>
            <hr className="lineHr-2"/>
            <p className="desc">Membuat tampilan website yang memberikan informasi terkait dengan
            Fikratussalam dengan berbagai fitur. 
            </p>
            ...
            <div className="wrapper-tecno">
                ...
                <img className="imgIcon" src="/assets/bootstrap.png" alt="" />
